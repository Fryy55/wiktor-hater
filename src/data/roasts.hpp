...
inline constexpr std::array roasts{
	...
	"You bring everyone so much joy, especially when oyu leave a room.",
	...
	"I'd love to stay and chat, but to be honest, I'd rather have open-heart surgery.",
	...
	"You have so many gaps in your teeth that it looks like your tongue is in jail.",
	...
	"Every time I think you can't get any dumber, you always prove me wrong.",
	"Don't be ashamed of who you are. That's a job for your parents.",
	"You see that door? I'd love it if you were on the other side of it.",
	...
	"I thought you were attractive when we first met, then you just had to open your mouth.",
	"Can you give me the name of your stylist or barber? I need to know where not to go.",
	"You have a face for radio.",
	"Even Bob Ross would call you a mistake.",
	"They say true beauty is on the inside. For your sake, I hope that's true.",
	"If ugly were a day, you'd be an entire year.",
	"There's no need for you to fear success... you have nothing to worry about.",
	"Your brain is kind of like a biscuit that's not done in the middle.",
	"Not to be mean, but I'm guessing you'll have a sparsely attended funeral.",
	"You're as useful as a screen door on a submarine.",
	"Your face could scare the crap out of a toilet.",
	"You can be anything you want in life... except rich, attractive and successful.",
	"How do your friends deal with you every day? Oh yeah, that's right - you don't have any!",
	"You aren't the dumbest person in the world, but you'd better hope they don't die.",
	...
	"Your hairstyle, it's a work of art! If the goal was to scare, you've played your part.",
	...
	"You think you're fire, but you're just smoke - all that talk and you're still broke.",
	"You're always giving advice like a sage, yet you live like you're in a cage.",
	"You're a human form of Wednesday morning: unwanted, not needed and totally boring.",
	"Your rhymes are straight whack and you have stinky breath, looks like you need a Tic Tac.",
	"You talk like a boss, yet you floss no gloss.",
	"You brag non-stop, but your skills are a flop.",
	"Your sense of humor, it's a little thin, maybe it got lost in your double chin.",
	"Your memory is a fleeting breeze, a forgotten face with such great ease.",
